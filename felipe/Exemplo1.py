...
delta = 3e-3
z_f = round(Nz * 0)  # Transductor z coordinate
x_f = round(Nx / 2)  # Transductor x coordinate
x_pois = x_f  # x coordinate for pressure sensors
z_poi1 = round(Nx * 0.2)  # z coordinate for each pressure sensor
z_poi2 = round(Nx * 0.25)
z_poi3 = round(Nx * 0.3)  
z_poi4 = round(Nx * 0.35)  
z_poi5 = round(Nx * 0.55)
z_poi6 = round(Nx * 0.6)
z_poi7 = round(Nx * 0.65)
z_poi8 = round(Nx * 0.7)
z_poi9 = round(Nx * 0.75)
