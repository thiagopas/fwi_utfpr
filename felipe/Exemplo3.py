...
plt.plot(t, u_at_poi1/np.linalg.norm(u_at_poi1), label='Medido em outro pixel')
...
plt.figure(6)
plt.plot(t, u_at_poi4/np.linalg.norm(u_at_poi4), 'b', label='Medido no fonte')
